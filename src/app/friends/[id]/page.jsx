        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 flex flex-col gap-5">
                ...
                <div className="bg-white/80 backdrop-blur rounded-3xl p-6 border border-gray-100 shadow-sm">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                            <button onClick={() => addTimeline(`📞 Call with ${friend.name}`)} className="flex flex-col items-center gap-2 py-5 border border-gray-100 rounded-2xl hover:bg-gray-50 transition hover:shadow-sm">
                                <Phone size={20} className="text-gray-700" />
                                <span className="text-sm text-gray-600">Call</span>
                            </button>
                            <button className="flex flex-col items-center gap-2 py-5 border border-gray-100 rounded-2xl hover:bg-gray-50 transition hover:shadow-sm">
